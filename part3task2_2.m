...
for i = 1:21
    ...
    for j = 1:1420 % # of data subcarriers
        Hk = [Hw1(j,i);Hw2(j,i)]; % Est. channel for the kth subcarrier of two hydrophones
        Zk = [z_w1(j,i);z_w2(j,i)]; % Received freq domain for the kth subcarrier of two hydrophones
        Hknorm = sqrt(Hk'*Hk);
        qk(j,i) = (Hk'*Zk)/(Hknorm); % Projected signal of kth subcarrier of two hydrophones
